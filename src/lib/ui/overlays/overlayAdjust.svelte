  ...
  <div class="relative">
    <Popover.Root>
      <Popover.Trigger
        ...
        class={classes(
          'h-4 w-4 rounded-full border border-white/30 bg-gradient-to-r cursor-pointer opacity-80 transition-opacity hover:opacity-100 focus:ring-1 focus:ring-blue-500',
